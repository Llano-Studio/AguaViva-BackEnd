...
export class SubscriptionPlanResponseDto {
  ...
  @ApiProperty({
    ...
    example: 'Entrega mensual de 4 bidones de 20L.',
    required: false,
  })
  description?: string;
  ...
  @ApiProperty({
    ...
    properties: {
      total: {
        type: 'number',
        example: 50,
        description: 'Total de planes de suscripción disponibles',
      },
      page: {
        type: 'number',
        example: 1,
      ...
      limit: {
        type: 'number',
        example: 10,
        description: 'Número de planes de suscripción por página',
      },
      totalPages: {
        type: 'number',
        example: 5,
