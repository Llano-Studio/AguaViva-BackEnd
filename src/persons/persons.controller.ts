...
export class PersonsController {
  ...
  @ApiResponse({
    status: 409,
    description: 'Conflicto, ej: CUIT/Email ya existe',
  })
  createPerson(
...
- Migración a nuevas estructuras de precios`,
  ...
  @ApiOperation({
    ...
    description:
      'Lista todos los comodatos del sistema con opciones de filtrado avanzado',
  })
  @ApiQuery({
    name: 'person_id',
    required: false,
  ...
  @ApiQuery({
    ...
    required: false,
    type: String,
    description: 'Fecha de devolución esperada desde (YYYY-MM-DD)',
  })
  @ApiQuery({
    name: 'expected_return_date_to',
    required: false,
    type: String,
    description: 'Fecha de devolución esperada hasta (YYYY-MM-DD)',
  })
  @ApiQuery({
    name: 'actual_return_date_from',
    required: false,
    type: String,
    description: 'Fecha de devolución real desde (YYYY-MM-DD)',
  })
  @ApiQuery({
    name: 'actual_return_date_to',
    required: false,
    type: String,
    description: 'Fecha de devolución real hasta (YYYY-MM-DD)',
  })
  @ApiQuery({
    name: 'search',
    required: false,
  ...
  @ApiResponse({
    status: 200,
    description: 'Lista de comodatos obtenida exitosamente',
    type: [ComodatoResponseDto],
  })
  async getAllComodatos(@Query() filters: any): Promise<ComodatoResponseDto[]> {
  ...
  @ApiOperation({
    ...
    description:
      'Lista todos los comodatos del sistema con opciones de filtrado avanzado - endpoint público para pruebas',
  })
  @ApiQuery({
    name: 'person_id',
    required: false,
