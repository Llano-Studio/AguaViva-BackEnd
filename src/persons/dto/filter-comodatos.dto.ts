...
export class FilterComodatosDto extends PaginationQueryDto {
  @ApiPropertyOptional({
    example: 1,
    description: 'Filtrar por ID de persona/cliente',
  })
  @IsOptional()
  @Type(() => Number)
  @IsInt()
  ...
  @ApiPropertyOptional({
    example: '2025-01-01',
    description: 'Fecha de entrega desde',
  })
  @IsOptional()
  @IsDateString()
  ...
  @ApiPropertyOptional({
    example: '2025-12-31',
    description: 'Fecha de entrega hasta',
  })
  @IsOptional()
  @IsDateString()
  ...
  @ApiPropertyOptional({
    example: '2025-01-01',
    description: 'Fecha de devolución esperada desde',
  })
  @IsOptional()
  @IsDateString()
  ...
  @ApiPropertyOptional({
    example: '2025-12-31',
    description: 'Fecha de devolución esperada hasta',
  })
  @IsOptional()
  @IsDateString()
  ...
  @ApiPropertyOptional({
    example: '2025-01-01',
    description: 'Fecha de devolución real desde',
  })
  @IsOptional()
  @IsDateString()
  ...
  @ApiPropertyOptional({
    example: '2025-12-31',
    description: 'Fecha de devolución real hasta',
  })
  @IsOptional()
  @IsDateString()
  ...
  @ApiPropertyOptional({
    example: 'bidón',
    description: 'Búsqueda general en notas y nombres',
  })
  @IsOptional()
  @IsString()
  search?: string;
