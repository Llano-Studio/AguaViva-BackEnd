...
export class UpdateComodatoDto {
  @ApiPropertyOptional({
    example: 2,
    description: 'Nuevo ID del producto en comodato',
  })
  @IsInt()
  @Min(1)
  @IsOptional()
  ...
  @ApiPropertyOptional({
    example: '2025-02-15',
    description: 'Nueva fecha de entrega del comodato',
  })
  @IsDateString()
  @IsOptional()
  ...
  @ApiPropertyOptional({
    example: '2025-12-31',
    description: 'Nueva fecha esperada de devolución',
  })
  @IsDateString()
  @IsOptional()
  ...
  @ApiPropertyOptional({
    example: 'Cliente devolvió los bidones en buen estado',
  ...
  @ApiPropertyOptional({ example: 600.0, description: 'Nueva cuota mensual' })
  @IsNumber({ maxDecimalPlaces: 2 })
  @IsOptional()
  @Min(0)
  monthly_fee?: number;
  ...
  @ApiPropertyOptional({
    example: 'Dispensador de agua fría/caliente actualizado',
  ...
  @ApiPropertyOptional({
    example: '/uploads/contracts/comodato_123_contract_updated.jpg',
    description: 'Nueva ruta de imagen del contrato',
  })
  @IsString()
  @IsOptional()
