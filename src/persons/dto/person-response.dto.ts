...
export class LoanedProductDetailDto {
  ...
  @ApiProperty({
    example: 3,
    description: 'Cantidad neta del producto en comodato con el cliente',
  })
  loaned_quantity: number;

  @ApiProperty({
    example: '2024-01-15',
    description: 'Fecha de adquisición del producto',
  })
  acquisition_date: string;

  @ApiProperty({
    example: 123,
    description: 'ID del pedido donde se adquirió el producto',
  })
  order_id: number;

  @ApiProperty({
    example: 'DELIVERED',
    description: 'Estado del pedido donde se adquirió',
  })
  order_status: string;
}
...
export class PersonResponseDto extends CreatePersonDto {
  ...
  @ApiProperty({
    ...
    example: {
      locality_id: 1,
      name: 'Rosario',
      province: { province_id: 1, name: 'Santa Fe' },
    },
  })
  locality: any;
  ...
  @ApiProperty({
    ...
    description:
      'Lista detallada de productos en comodato por el cliente con fechas de adquisición',
    example: [
      {
        product_id: 1,
  ...
  @ApiProperty({
    example: 'YELLOW',
    description:
      'Estado del semáforo de pagos del cliente (NONE, GREEN, YELLOW, RED)',
  ...
  @ApiProperty({
    ...
    description:
      'Créditos disponibles (bidones a favor) por suscripción activa',
    example: [
      {
        product_id: 1,
