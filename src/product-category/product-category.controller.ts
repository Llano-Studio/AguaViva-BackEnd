...
export class ProductCategoryController {
  ...
  @ApiOperation({
    summary:
      'Listar todas las categorías de productos con paginación y filtros',
    description:
      'Obtiene un listado de todas las categorías de productos disponibles en el sistema, permitiendo paginación, ordenamiento y filtros.',
  })
  @ApiQuery({
    name: 'search',
    required: false,
  ...
  @ApiQuery({
    ...
    required: false,
    type: String,
    description: 'Filtrar por nombre específico de categoría',
    example: 'Bidones',
  })
  @ApiQuery({
    name: 'page',
  ...
  @ApiQuery({
    ...
    required: false,
    type: String,
    description: 'Campo para ordenar (ej: name, -name)',
    example: 'name',
  })
  @ApiResponse({
    status: 200,
  ...
  @ApiOperation({
    ...
    description:
      'Devuelve la información detallada de una categoría de productos específica según su ID.',
  })
  @ApiParam({
    name: 'id',
    type: 'integer',
