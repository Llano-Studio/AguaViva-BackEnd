...
export class PdfGeneratorService {
  ...
  private async generateRouteSheetContent(
    ...
    const primaryColor = this.normalizeHexColor(customColors.primary) || '#181594';
    const secondaryColor = this.normalizeHexColor(customColors.secondary) || '#0047aa';
    const accentColor = this.normalizeHexColor(customColors.accent) || '#f59e0b';
    const lightGray = this.normalizeHexColor(customColors.lightGray) || '#f312cd';
