...
export class OrderItemResponseDto {
  ...
  @ApiProperty({
    description:
      '🆕 ID de la lista de precios utilizada para este producto (opcional)',
    example: 3,
    nullable: true,
  })
  ...
  @ApiProperty({
    description:
      '🆕 ID del plan de suscripción (abono) asociado al producto en órdenes híbridas',
    example: 1,
    nullable: true,
  })
  abono_id?: number;
  ...
  @ApiProperty({
    description:
      '🆕 Nombre del plan de suscripción (abono) asociado al producto en órdenes híbridas',
