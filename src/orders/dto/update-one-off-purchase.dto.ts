...
export class UpdateOneOffPurchaseItemDto {
  ...
  @ApiPropertyOptional({
    description:
      'ID de la lista de precios (opcional, usa la lista por defecto si no se especifica)',
    example: 1,
  })
  @IsOptional()
  @IsInt()
...
export class UpdateOneOffPurchaseDto {
  ...
  @ApiPropertyOptional({
    description:
      'Lista de productos a actualizar. Estructura simplificada con product_id y quantity.',
