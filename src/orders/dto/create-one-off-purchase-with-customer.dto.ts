import { IsInt, IsNotEmpty, IsOptional, IsString, Min, IsDateString, IsArray, ValidateNested, IsEnum, IsBoolean } from 'class-validator';
...
export class CreateOneOffPurchaseWithCustomerDto {
  ...
  @ApiPropertyOptional({
    description: 'Dirección de entrega específica (opcional, si no se especifica usa la dirección del cliente)',
  ...
  @ApiPropertyOptional({
    description: 'ID de la localidad para la entrega (opcional, si no se especifica usa la del cliente)',
    example: 1
  })
  @IsOptional()
  @IsInt()
  ...
  @ApiPropertyOptional({
    description: 'ID de la zona para la entrega (opcional, si no se especifica usa la del cliente)',
    example: 1
  })
  @IsOptional()
  @IsInt()
  ...
  @ApiProperty({
    description: 'Indica si el pedido requiere entrega a domicilio (true) o el cliente pasa a retirar (false)',
    example: true
  })
  @IsBoolean()
  @IsNotEmpty()
