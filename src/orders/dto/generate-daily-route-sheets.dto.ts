...
export class GenerateDailyRouteSheetsDto {
  ...
  @ApiPropertyOptional({
    description: 'ID del vehículo a procesar (opcional)',
    example: 4,
  })
  @IsOptional()
  @Type(() => Number)
  ...
  @ApiPropertyOptional({
    description: 'IDs de zonas a incluir (opcional)',
    type: [Number],
    example: [3, 7, 9],
  })
  @IsOptional()
  ...
  @ApiPropertyOptional({
    description: 'ID del conductor (opcional)',
    example: 12,
  })
  @IsOptional()
  @Type(() => Number)
  ...
  @ApiPropertyOptional({
    description: 'Solo cobranzas vencidas',
    example: 'false',
    enum: ['true', 'false'],
  })
  @IsOptional()
  ...
  @ApiPropertyOptional({
    ...
    example: 'zone',
    enum: ['zone', 'amount', 'priority', 'customer'],
  })
  @IsOptional()
  ...
  @ApiPropertyOptional({
    description: 'Notas para la hoja de ruta',
    example: 'Generación manual diaria',
  })
  @IsOptional()
  notes?: string;
}
