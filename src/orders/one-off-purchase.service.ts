...
export class OneOffPurchaseService extends PrismaClient implements OnModuleInit {
    private readonly entityName = 'Compra de Una Vez';
    ...
    /**
     * Función privada para manejar la renovación de stock de productos no retornables
     * al eliminar compras. Unifica la lógica común entre todos los métodos de eliminación.
     */
