...
export class ZonesController {
  ...
  @ApiQuery({ name: 'locality_id', required: false, type: Number, description: "Filtrar por ID de localidad (para compatibilidad)", example: 1 })
  @ApiQuery({ name: 'locality_ids', required: false, type: String, description: "Filtrar por IDs de localidades múltiples. Formato: '1,2,3' o array [1,2,3]", example: "1,2,3" })
